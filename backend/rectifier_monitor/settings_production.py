"""
Production Settings for Rectifier Monitor
"""
import os
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'dd37f50847e46df268486ce9c1f172e3a8489d9793abf2bd2b0a44e5b919c859044ac787e76910aba2f43ab1d7d0212eb7d7')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.environ.get('DEBUG', 'False') == 'True'

ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', "localhost,127.0.0.1,103.176.45.14").split(',')
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.environ.get('POSTGRES_PASSWORD', 'rectifier_password'),
...
MQTT_USERNAME = os.environ.get('MQTT_USERNAME', '')  # Optional
MQTT_PASSWORD = os.environ.get('MQTT_PASSWORD', '')  # Optional
